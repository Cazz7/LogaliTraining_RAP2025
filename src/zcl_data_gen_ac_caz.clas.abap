class zcl_data_gen_ac_caz definition
  public
  final
  create public .
...
class zcl_data_gen_ac_caz implementation.

  method if_oo_adt_classrun~main.

    data: lt_acc_categ type table of ztb_acc_cate_caz,
          lt_catego    type table of ztb_catego_caz,
          lt_clientes  type table of ztb_clientes_Caz,
          lt_clnts_lib type table of ztb_clnt_lib_caz,
...
******** ztb_acc_cate_caz ********
    ...
    insert ztb_acc_cate_caz from table @lt_acc_categ.
...
******** ztb_clnt_lib_caz
    ...
    insert ztb_clnt_lib_caz from table @lt_clnts_lib.
