CLASS zcl_flight_amdp_caz DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    CLASS-METHODS convert_currency AMDP OPTIONS CDS SESSION CLIENT DEPENDENT IMPORTING VALUE(iv_amount)               TYPE /dmo/total_price
...
CLASS zcl_flight_amdp_caz IMPLEMENTATION.
